#!/bin/bash
# This script checks if a process is listening on a specified port, scans the process for malicious activity using VirusTotal, and blocks it if identified as malicious.
PORT=$1  
